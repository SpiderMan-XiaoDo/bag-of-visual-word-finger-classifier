...
train_img= cv2.imread(r'baocao_computervision\dataset\train\right\9\399936902_1636220883572438_1511662369061276962_n.jpg',0) # train image

print(train_img)
cv2.imshow('image', train_img)
